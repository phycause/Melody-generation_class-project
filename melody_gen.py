...
class PTBInput(object):
  ...
  def __init__(self, config, data, name=None):
    ...
    self.input_data, self.targets = midi_reader.ptb_producer(
...
def get_config():
  ...
  if FLAGS.model == "small":
    config = config_setting.SmallConfig()
  elif FLAGS.model == "medium":
    config = config_setting.MediumConfig()
  elif FLAGS.model == "large":
    config = config_setting.LargeConfig()
  elif FLAGS.model == "test":
    config = config_setting.TestConfig()
  else:
...
def main(_):
  ...
  raw_data = midi_reader.ptb_raw_data(FLAGS.data_path)
